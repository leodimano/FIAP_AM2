...
namespace X_UniTMX
{
    ...
    public class Map
    {
        ...
        public void ApplyCustomProperties(GameObject gameObject, MapObject obj)
        {
            ...
            {
                //gameObject.AddComponent(typeof(Map));
                //UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(gameObject, "Assets/X-UniTMX/Code/Map.cs (2684,5)", Property_AddComponent + c);
                c++;
            }
            c = 1;
